...
import {
    ...
    formatarDataSimples // <<< ADICIONAR IMPORTAÇÃO SE NÃO ESTIVER
} from './pdfUtils.js';
...
export const addTermoManifestacao = (doc, data) => {
    ...
    vitimas.forEach((vitima, index) => {
        ...
        // const apresentacaoJuizado = data.tco?.apresentacaoJuizadoEspecialVG; // << REMOVIDO
        // const dataAudiencia = apresentacaoJuizado?.data || "[DATA NÃO INFORMADA]"; // << REMOVIDO
        // const horaAudiencia = apresentacaoJuizado?.hora || "[HORA NÃO INFORMADA]"; // << REMOVIDO

        // Aplicar a mesma lógica de PDFTermoCompromisso.js
