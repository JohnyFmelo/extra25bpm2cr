...
const HistoricoTab: React.FC<HistoricoTabProps> = ({
  ...
  return <div className="border rounded-lg shadow-sm bg-white">
      ...
      <div className="p-6 space-y-6 px-[6px]">
              ...
              return (
                <div key={`autor-relato-${index}`} className="mb-6">
                  ...
                  <Textarea 
                    ...
                    value={autor.relato || "DECLAROU O AUTOR, ABAIXO ASSINADO, JÁ QUALIFICADO NOS AUTOS, QUE [INSIRA DECLARAÇÃO]. LIDO E ACHADO CONFORME. NADA MAIS DISSE E NEM LHE FOI PERGUNTADO."} 
        ...
        {/* Fallback: Show general author testimony field if no valid individual authors */}
        {validAutores.length === 0 && (
          <div>
