...
const TCOmeus: React.FC<TCOmeusProps> = ({ user, toast, setSelectedTco, selectedTco }) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6 flex-grow overflow-hidden flex flex-col">
        ...
        <AlertDialogContent className="max-w-md rounded-lg">
          ...
          <AlertDialogFooter className="gap-2 flex-col sm:flex-row">
            ...
            <AlertDialogAction 
              ...
              disabled={isDeleting}
              className="bg-red-500 hover:bg-red-600 w-full sm:w-auto transition-colors"
            >
              {isDeleting ? (
                <div className="flex items-center gap-2">
