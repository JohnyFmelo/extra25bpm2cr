...
const TimeSlotsList = () => {
  ...
  return (
    <div className="space-y-6 p-4">
              ...
              <div className="flex flex-col items-center">
                <div className="flex items-center justify-between w-full mb-2">
                  <div className="flex items-center gap-2">
                    ...
                    {isAdmin && dailyCost > 0 && ( // Renderiza o custo diário apenas se for maior que 0
                      <span className="text-sm text-green-600 font-semibold">R$ {dailyCost.toFixed(2)}</span>
                    )}
                  </div>
      ...
      {isAdmin && totalCostSummary["Total Geral"] > 0 && ( // Renderiza o Resumo de Custos Totais apenas se Total Geral for maior que 0
