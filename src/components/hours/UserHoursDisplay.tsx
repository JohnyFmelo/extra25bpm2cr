      ...
      <div className="space-y-4">
        {bpmDays.length > 0 && (
          <div className="bg-slate-50 rounded-lg p-3 shadow-sm border border-slate-100">
            <h3 className="font-semibold mb-2 flex items-start mx-0 px-0 text-gray-700"> {/* Alterado para alinhamento à esquerda */}
              <span className="flex items-start mx-0"> {/* Alterado para alinhamento à esquerda */}
        ...
        {saiopDays.length > 0 && (
          <div className="rounded-lg p-3 shadow-sm border border-blue-100 bg-slate-50">
            <h3 className="font-semibold mb-2 text-blue-700 flex items-start"> {/* Alterado para alinhamento à esquerda */}
              <span className="flex items-start"> {/* Alterado para alinhamento à esquerda */}
        ...
        {sinfraDays.length > 0 && (
          <div className="bg-green-50 rounded-lg p-3 shadow-sm border border-green-100">
            <h3 className="font-semibold mb-2 text-green-700 flex items-start"> {/* Alterado para alinhamento à esquerda */}
              <span className="flex items-start"> {/* Alterado para alinhamento à esquerda */}
