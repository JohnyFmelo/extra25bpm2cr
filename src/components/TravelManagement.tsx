  ...
  return <>
      <div className="max-w-7xl mx-auto p-4">
        {isAdmin && <div className="text-center mb-8 p-6 bg-white rounded-2xl shadow-lg">
                <h1 className="text-3xl font-bold text-slate-800 mb-2 flex items-center justify-center gap-3"><Handshake className="h-8 w-8" />SINFRA - Sistema de Voluntariado</h1>
