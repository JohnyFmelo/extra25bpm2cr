...
const Index = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gray-100 flex flex-col px-4 py-6 sm:px-6 lg:px-8">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6 flex flex-col flex-grow">
          ...
          <TabsContent value="main" className="flex-grow">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {hasNotifications && (
                <Card className="col-span-1 lg:col-span-2 shadow-lg border-l-4 border-amber-500">
                  <CardContent className="p-6">
                    <div className="flex items-center mb-4">
                      <CalendarDays className="h-6 w-6 text-amber-500 mr-3" />
                ...
                <CardContent className="p-6">
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    <button
                      ...
                      className="p-4 text-left bg-white hover:bg-gray-50 rounded-lg shadow-sm transition-colors"
                    >
                    ...
                    <button
                      ...
                      className="p-4 text-left bg-red-50 hover:bg-red-100 rounded-lg shadow-sm transition-colors"
                    >
                      <div className="flex items-center gap-3">
