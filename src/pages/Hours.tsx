...
const Hours = () => {
    ...
    const [consultationTime, setConsultationTime] = useState<number | null>(null);  // Novo estado para o tempo de consulta
    ...
    const handleGeneralConsult = async () => {
        ...
        setConsultationTime(null); // Resetando o tempo
        const startTime = performance.now(); // Iniciando o cronômetro
        ...
        try {
            ...
            const endTime = performance.now(); // Finalizando o cronômetro
            const duration = endTime - startTime; // Calculando a duração
            setConsultationTime(duration); // Definindo o tempo de consulta
        }
    };
                        ...
                        <div className="space-y-4">
                            ...
                            {consultationTime !== null && (
                                <p className="text-sm text-gray-500">
                                    Tempo de consulta: {consultationTime.toFixed(2)} ms
                                </p>
                            )}
                        </div>
                    </div>
